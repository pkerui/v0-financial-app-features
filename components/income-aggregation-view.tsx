...
import { TrendingUp, Store as StoreIcon } from 'lucide-react'
...
interface IncomeAggregationViewProps {
...
export function IncomeAggregationView({
  storeSummaries,
  stores,
  startDate,
  endDate,
}: IncomeAggregationViewProps) {
  // 计算总收入
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>每个店铺的分类收入详情</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
